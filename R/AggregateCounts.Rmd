...
tTestFigs2ABDataCorEdge<-list(Pawt5CorEdBioTtest,Pawt5CorEdFreqTtest,Pawt10CorEdFreqTtest,Pawt100CorEdFreqTtest,
                       Sawt5CorEdBioTtest,Sawt5CorEdFreqTtest,Sawt10CorEdFreqTtest,Sawt100CorEdFreqTtest)

tTestFigs2ABTableCorEdge<-bind_rows(map(tTestFigs2ABDataCorEdge, TtestTable))
...
summary(Pabiomass5Aov)
TukeyHSD(Pabiomass5Aov)
...
tTestFigs2CDTable<-bind_rows(map(tTestFigs2CDData, TtestTable))
